...
using _8Tracks._Tracks_XamlTypeInfo;
...
namespace _8Tracks._Tracks_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_LayoutAwarePage() { return new _8Tracks.Common.LayoutAwarePage(); }

        private object Activate_1_RichTextColumns() { return new _8Tracks.Common.RichTextColumns(); }

        private object Activate_2_MixDetailPage() { return new _8Tracks.MixDetailPage(); }

        private object Activate_3_GroupedItemsPage() { return new _8Tracks.GroupedItemsPage(); }

        private object Activate_4_GroupDetailPage() { return new _8Tracks.GroupDetailPage(); }

        private object Activate_5_ItemDetailPage() { return new _8Tracks.ItemDetailPage(); }
        ...
        {
            var that = (_8Tracks.Common.RichTextColumns)instance;
